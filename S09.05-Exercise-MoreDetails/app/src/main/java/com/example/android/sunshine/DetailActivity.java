...
public class DetailActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    TextView date, description, high, low, humidity, wind, pressure;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        description = (TextView) findViewById(R.id.tv_details_weather_description);
        high = (TextView) findViewById(R.id.tv_details_high_temperature);
        low = (TextView) findViewById(R.id.tv_details_low_temperature);
        humidity = (TextView) findViewById(R.id.tv_details_humidity);
        wind = (TextView) findViewById(R.id.tv_details_wind);
        pressure = (TextView) findViewById(R.id.tv_details_pressure);
